...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd = CreateWindow(CLASS_NAME, WINDOW_NAME, WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX,
                             CW_USEDEFAULT, CW_USEDEFAULT, 360, 540, NULL, NULL, NULL, NULL);
    outputScreen = CreateWindow("static", "0", WS_VISIBLE | WS_CHILD | ES_RIGHT, 10, 20, 335, 100, hwnd, NULL, NULL, NULL);
    inputScreen = CreateWindow("static", "0", WS_VISIBLE | WS_CHILD | ES_RIGHT, 10, 130, 335, 50, hwnd, NULL, NULL, NULL);

    bt_C = CreateWindow("button", "C", WS_VISIBLE | WS_CHILD, 10, 200, 80, 50, hwnd, NULL, NULL, NULL);
    bt_back = CreateWindow("button", "back", WS_VISIBLE | WS_CHILD, 95, 200, 80, 50, hwnd, NULL, NULL, NULL);
    bt_percent = CreateWindow("button", "%", WS_VISIBLE | WS_CHILD, 180, 200, 80, 50, hwnd, NULL, NULL, NULL);
    bt_division = CreateWindow("button", "/", WS_VISIBLE | WS_CHILD, 265, 200, 80, 50, hwnd, NULL, NULL, NULL);
    bt_7 = CreateWindow("button", "7", WS_VISIBLE | WS_CHILD, 10, 260, 80, 50, hwnd, NULL, NULL, NULL);
    bt_8 = CreateWindow("button", "8", WS_VISIBLE | WS_CHILD, 95, 260, 80, 50, hwnd, NULL, NULL, NULL);
    bt_9 = CreateWindow("button", "9", WS_VISIBLE | WS_CHILD, 180, 260, 80, 50, hwnd, NULL, NULL, NULL);
    bt_multi = CreateWindow("button", "X", WS_VISIBLE | WS_CHILD, 265, 260, 80, 50, hwnd, NULL, NULL, NULL);
    bt_4 = CreateWindow("button", "4", WS_VISIBLE | WS_CHILD, 10, 320, 80, 50, hwnd, NULL, NULL, NULL);
    bt_5 = CreateWindow("button", "5", WS_VISIBLE | WS_CHILD, 95, 320, 80, 50, hwnd, NULL, NULL, NULL);
    bt_6 = CreateWindow("button", "6", WS_VISIBLE | WS_CHILD, 180, 320, 80, 50, hwnd, NULL, NULL, NULL);
    bt_minus = CreateWindow("button", "-", WS_VISIBLE | WS_CHILD, 265, 320, 80, 50, hwnd, NULL, NULL, NULL);
    bt_1 = CreateWindow("button", "1", WS_VISIBLE | WS_CHILD, 10, 380, 80, 50, hwnd, NULL, NULL, NULL);
    bt_2 = CreateWindow("button", "2", WS_VISIBLE | WS_CHILD, 95, 380, 80, 50, hwnd, NULL, NULL, NULL);
    bt_3 = CreateWindow("button", "3", WS_VISIBLE | WS_CHILD, 180, 380, 80, 50, hwnd, NULL, NULL, NULL);
    bt_plus = CreateWindow("button", "+", WS_VISIBLE | WS_CHILD, 265, 380, 80, 50, hwnd, NULL, NULL, NULL);
    bt_plusAndMinus = CreateWindow("button", "+/-", WS_VISIBLE | WS_CHILD, 10, 440, 80, 50, hwnd, NULL, NULL, NULL);
    bt_0 = CreateWindow("button", "0", WS_VISIBLE | WS_CHILD, 95, 440, 80, 50, hwnd, NULL, NULL, NULL);
    bt_point = CreateWindow("button", ",", WS_VISIBLE | WS_CHILD, 180, 440, 80, 50, hwnd, NULL, NULL, NULL);
    bt_equals = CreateWindow("button", "=", WS_VISIBLE | WS_CHILD, 265, 440, 80, 50, hwnd, NULL, NULL, NULL);
